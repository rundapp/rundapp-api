...
async def test_create(
    ...
    test_challenge = await challenges_repo.create(
        new_challenge=create_challenge_repo_adapter
    )
...
async def test_retrieve_many(
    ...
    test_challenges = await challenges_repo.retrieve_many(
...
async def test_update_challenge(
    ...
    updated_test_challenge = await challenges_repo.update_challenge(
...
async def test_update_payment(
    ...
    updated_test_challenge = await challenges_repo.retrieve(
        id=inserted_challenge_object.id
    )
